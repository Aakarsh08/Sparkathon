        ...
        <Card>
          <CardBody>
            ...
            <Typography className="mb-4">
              Have questions about RetailIQ or want to request a demo?
              Our team is here to help your business make smarter inventory decisions.
            </Typography>

            <div className="space-y-4">
              <Typography variant="h6">Contact Information:</Typography>
              <Typography>Email: support@retailiq.com</Typography>
              <Typography>Phone: +1 (555) 123-4567</Typography>
              <Typography>Address: SmartRetail HQ, Analytics Avenue</Typography>
            </div>
          </CardBody>
        </Card>
